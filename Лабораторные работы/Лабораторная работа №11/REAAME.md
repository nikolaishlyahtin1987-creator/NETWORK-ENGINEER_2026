...
### **Шаг 3. Проверка работы ACL**   
### Выполним следующие действия с PC-A (Operations) и PC-B (Sales) согласно таблице     
![alt text](image-110.png)     

#### **С PC-A:**
#### 1. ![alt text](image-111.png)     
#### Заблокирован политикой 4   

#### 2. ![alt text](image-112.png)    
#### Разрешен     

#### **С PC-B**      
#### 3. ![alt text](image-113.png)     
#### Заблокирован политикой 3     
...
#### 6. Так как в Packet Tracer нет возможности открыть браузер с HTTPS, будем проверять попытки подключения с помощью команды telnet к порту 443. Это позволит проверить, пропускает ли ACL TCP‑пакеты на этот порт. После каждой попытки посмотрим на счётчики ACL на маршрутизаторе R1.     

#### Cбросим счётчики на R1
![alt text](image-116.png)     

#### На PC-B выполним telnet 10.20.0.1 443    
  ![alt text](image-117.png)      
#### Подключение не установилось, потому что ACL блокирует пакеты.      
#### Просмотр счётчиков ACL на R1        
![alt text](image-118.png)   

#### На PC-B снова выполним telnet 10.20.0.1 443     
![alt text](image-119.png)     
#### Количество совпадений (matches) стало больше. Это означает, что HTTPS-пакет был успешно заблокирован этим правилом.    

#### 7. Выполним на PC-B telnet 172.16.1.1 443     
![alt text](image-120.png)    

#### Снова смотрим счётчики ACL на R1     
![alt text](image-121.png)     

#### Снова на PC-B выполним telnet 172.16.1.1 443 и посмотрим счетчики на R1    
![alt text](image-122.png)     
#### Строка осталась с 24 match – она не увеличилась. Это означает, что пакет к 172.16.1.1 был пропущен этим правилом.   

#### 8. Проверяем SSH
![alt text](image-123.png)    
#### Получили отказ, правило сработало      

#### 9. 
![alt text](image-124.png)    

#### Все результаты совпадают с заданной таблицей. ACL настроены и работают корректно.  


[Скачать конфиг лабораторной работы №11](https://github.com/nikolaishlyahtin1987-creator/NETWORK-ENGINEER_2026/blob/main/Лабораторные%20работы/Лабораторная%20работа%20№10/Лаб%20№10_OSPF.pkt "Нажмите для скачивания файла конфигурации")
