...
### **1.8.  Настройка ACL**      
#### **Ограничение SSH-доступа (на всех коммутаторах)**     
![alt text](image-28.png)     

#### **Блокировка трафика из VLAN 10 в VLAN 20 (на Core A1 и Core B1)**     
 ![alt text](image-29.png)     

### **1.9 Настройка ПК**     
#### 1. На каждом ПК:
#### 2. Войти в Desktop → IP Configuration.
#### 3. Выбрать DHCP.
#### 4. Убедиться, что DNS-сервер = 8.8.8.8.
#### 5. Выполнить ipconfig для проверки полученного адреса.
![alt text](image-30.png)     

## **2. Верификация**      
### **2.1 Проверка состояния интерфейсов**       
#### На каждом устройстве:     
![alt text](image-31.png)    
#### Все порты должны быть up/up.    

### **2.2 Проверка OSPF-соседей**     
![alt text](image-32.png)     
#### Все соседи должны быть в состоянии FULL.      

### **2.3 Проверка маршрутов**     
![alt text](image-33.png)    
#### Должны присутствовать все сети, помеченные как O (OSPF).      

### **2.4 Проверка DHCP**     
![alt text](image-34.png)    
#### Должен быть выдан IP из правильного пула.     

### **2.5 Проверка доступа в интернет**    
#### Чтобы смоделировать интернет, мы используем loopback-интерфейс на ISP Router (209.165.200.1), который играет роль удалённого сервера в интернете.   
...
#### Должны отображаться динамические записи.     

#### **2.7 Проверка ACL** 

### **SSH:**  
#### **С ПК из VLAN 100**     
#### Так как у нас нет ПК в VLAN 100, мы  временно настроим один из свободных портов на Access-коммутаторе в режим доступа в VLAN 100 и подключим к нему ПК для теста.
![alt text](image-37.png)     
#### Физически подключите ПК к порту Fa0/5 на Access-A1.     
#### Задаем статический адрес из диапазона VLAN 100:    
![alt text](image-38.png)     
#### На ПК выполняем ping
![alt text](image-39.png)     

#### Теперь с этого ПК проверяем SSH:   
![  ](image-40.png)   

### **С ПК из VLAN 10**     
  ![alt text](image-41.png)    
#### Это означает, что ACL сработал и заблокировал доступ.    

### **Изоляция:**    
#### **с ПК из VLAN 10 выполняем ping на ПК из VLAN 20**      
